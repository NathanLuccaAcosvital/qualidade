  ...
  return (
    <div className="w-full space-y-6">
      <header className="space-y-3">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#b23c0e]/10 rounded-xl border border-[#b23c0e]/20 text-[#8a2e0b] shadow-lg shadow-[#b23c0e]/10">
           <ShieldCheck size={12} className="text-[#b23c0e]" />
      ...
      <form onSubmit={(e) => onSubmit(e, email, password)} className="space-y-6">
        <div className="space-y-4">
          ...
          <div className="space-y-2 group">
            ...
            <div className={`flex items-center bg-slate-50 border-2 rounded-2xl overflow-hidden transition-all duration-300 ${focusedInput === 'email' ? 'border-blue-700 bg-white shadow-lg shadow-blue-500/5' : 'border-slate-100'}`}>
              <div className={`w-12 h-14 flex items-center justify-center border-r transition-colors ${focusedInput === 'email' ? 'text-blue-700 border-slate-100' : 'text-slate-300 border-slate-50'}`}>
                <Mail size={18} />
              </div>
              <input 
                id="login-email"
          ...
          <div className="space-y-2 group">
            ...
            <div className={`flex items-center bg-slate-50 border-2 rounded-2xl overflow-hidden transition-all duration-300 ${focusedInput === 'password' ? 'border-blue-700 bg-white shadow-lg shadow-blue-500/5' : 'border-slate-100'}`}>
              <div className={`w-12 h-14 flex items-center justify-center border-r transition-colors ${focusedInput === 'password' ? 'text-blue-700 border-slate-100' : 'text-slate-300 border-slate-50'}`}>
                <Lock size={18} />
              </div>
              <input 
                id="login-password"
        ...
        <button 
          ...
          className="w-full bg-[#040a1d] hover:bg-slate-800 text-white font-black h-14 rounded-2xl transition-all flex items-center justify-center gap-3 shadow-2xl shadow-blue-900/10 active:scale-[0.98] disabled:opacity-70 group overflow-hidden relative"
        >
