  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <QualityOverviewCards
        ...
        // onChangeView={(v) => setSearchParams({ view: v })} // Removido
      />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-[#081437] rounded-[2rem] p-10 text-white relative overflow-hidden shadow-xl border border-white/5">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <button 
              onClick={() => navigate('/quality/flow-audit')} // Redireciona para a nova página
            ...
            >
              Acessar Fluxo <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" />
            </button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[2rem] border border-slate-200 p-8 flex flex-col justify-between shadow-sm relative overflow-hidden">
          <div className="space-y-6 relative z-10">
            ...
            <button 
                onClick={() => navigate('/quality/explorer')} // Redireciona para o explorador
